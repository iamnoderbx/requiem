...
export type AnimationComponentData = { value: number }

export namespace EntityAnimationsComponent {
    ...
    class ComponentNetworkState extends ComponentWrapper.Data implements ComponentData<number> {
        ...
        constructor(data : AnimationComponentData) {
            super(EntityAnimationsComponent.Symbol)
        ...
        public rewrite(data : AnimationComponentData) : void {
