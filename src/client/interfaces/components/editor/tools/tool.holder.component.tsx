...
export default function EditorToolHolderComponent(props: {} & Roact.PropsWithChildren): Roact.Element {
	return (
		<imagelabel
			...
			BorderSizePixel={0}
			Position={UDim2.fromScale(0.159, 0.701)}
			Size={UDim2.fromScale(0.0681, 0.0398)}
			ZIndex={2}
			Key={"menu1"}
		>
			<uicorner
