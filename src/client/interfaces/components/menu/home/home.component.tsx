...
export function MenuHomePageComponent(props : {visible : Binding<boolean>, selected : boolean} & Roact.PropsWithChildren) : Roact.Element {
...
export default MenuHomePageComponent;